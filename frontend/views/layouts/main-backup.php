...
<?php $this->beginBody() ?>
 ...
 -->
			...
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3" style="width: 40%; ">
				...
				<ul>
					<li class="p-b-10">
						<span href="#" class="fs-18 color1 p-r-20 fa fa-location-arrow"></span> <span>Jl. Kl. Yos Sudarso KM. 19 Link 17 Pekan Labuhan</span>
					</li>
					<li class="p-b-9">
					...
					<li class="p-b-9">
						<span href="#" class="fs-18 color1 p-r-20 fa fa-envelope"></span> <span>20253</span>
