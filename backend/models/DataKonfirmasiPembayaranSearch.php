...
/**
 * DataKonfirmasiPembayaranSearch represents the model behind the search form of `common\models\TbKonfimasiPembayaran`.
 */
class DataKonfirmasiPembayaranSearch extends TbKonfimasiPembayaran
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'id_user', 'no_pesanan', 'jumlah_transfer', 'id_file'], 'integer'],
